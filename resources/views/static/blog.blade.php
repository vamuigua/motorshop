    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <form id="search_form" name="gs" method="GET" action="#">
          <input type="text" name="q" class="form-control form-control-lg" placeholder="type to search..."
            autocomplete="on">
        </form>
        ...
        <ul>
          <li>
            <h5 style="margin-bottom:10px;"><a href="blog-details.html">Dolorum corporis ullam, reiciendis inventore est
                repudiandae</a></h5>
            <small><i class="fas fa-user"></i> John Doe &nbsp;|&nbsp; <i class="fas fa-calendar"></i> 27.07.2020
              10:10</small>
          </li>
          ...
          <li>
            <h5 style="margin-bottom:10px;"><a href="blog-details.html">Culpa ab quasi in rerum dolorum impedit
                expedita</a></h5>
            <small><i class="fas fa-user"></i> John Doe &nbsp;|&nbsp; <i class="fas fa-calendar"></i> 27.07.2020
              10:10</small>
          </li>
          ...
          <li>
            <h5 style="margin-bottom:10px;"><a href="blog-details.html">Explicabo soluta corrupti dolor doloribus optio
                dolorum</a></h5>
